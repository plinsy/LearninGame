...
//         if (ssd == 0) {
//             $(`.loginbox:first`).css('width', '80%');
//             $(`.userDiv:first`).addClass('col-md-6');
//             $(`.userDiv:first`).css('border-left', '1px solid white');
//             $(`.userDiv:first`).css('border-right', '1px solid transparent');
//             $(`.loginbox .form:first`).prepend(`
// 				<!-- Student Form -->
// 	            <div class="studentDiv col-md-6">
// 	                <h2>Identifiant de l'élève</h2>
...
//             ssd = 1;
//         } else if (ssd == 1) {
//             $(`.loginbox:first`).css('width', '39%');
//             $(`.userDiv:first`).removeClass('col-md-6');
//             $(`.userDiv:first`).css('border-left', '1px solid transparent');
//             $(`.studentDiv:first`).remove();
//             ssd = 0;
//             std = 0;
//         }
//         $(`.teacherDiv:first`).remove();
//     }
...
//             $(`.loginbox:first`).css('width', '80%');
//             $(`.userDiv:first`).addClass('col-md-6');
//             $(`.userDiv:first`).css('border-right', '1px solid white');
//             $(`.userDiv:first`).css('border-left', '1px solid transparent');
//             $(`.loginbox .form:first`).append(`
// 	            <!-- Teacher Form -->
// 	            <div class="teacherDiv col-md-6">
// 	                <h2>Identifiant du prof</h2>
// 	                <div class="inputloginbox">
// 	                    <input required="" type="text" value="" name="last_name" id="last_name">
// 	                    <label for="last_name">Nom</label><br>
// 	                </div>
...
//     $(`button.new_student:first`).on('click', function(event) {
//         // event.preventDefault();
//         showStudentDiv();
//         // else if (sdt == 1) { hideStudentDiv(); std = 0; }
//     });

//     $(`button.new_teacher:first`).on('click', function(event) {
//         // event.preventDefault();
//         showTeacherDiv();
//         // else if (tch == 1) { hideTeacherDiv(); tch = 0; }
//     });
